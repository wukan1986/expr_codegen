...
pset.addPrimitive(dummy, [Expr, Expr], Expr, name='cs_neutralize_residual_simple')
pset.addPrimitive(dummy, [Expr, float, float], Expr, name='cs_winsorize_mad')
pset.addPrimitive(dummy, [Expr, float, float], Expr, name='cs_winsorize_quantile')
pset.addPrimitive(dummy, [Expr, float], Expr, name='cs_winsorize_3sigma')
pset.addPrimitive(dummy, [Expr, int], Expr, name='cs_standardize_zscore')
pset.addPrimitive(dummy, [Expr], Expr, name='cs_neutralize_demean')
pset.addPrimitive(dummy, [Expr], Expr, name='cs_standardize_minmax')
...
pset.addPrimitive(dummy, [Expr, int], Expr, name='cs_bucket')
...
pset.addPrimitive(dummy, [Expr, Expr, Expr, int, int, int, int, int, int], Expr, name='ts_STOCH')
pset.addPrimitive(dummy, [Expr, Expr, Expr, int, int, int, int], Expr, name='ts_STOCHF')
...
pset.addPrimitive(dummy, [Expr, Expr, int, int], Expr, name='ts_AROON')
...
pset.addPrimitive(dummy, [Expr, Expr], Expr, name='ts_OBV')
pset.addPrimitive(dummy, [Expr, float, float, int], Expr, name='ts_MAMA')
pset.addPrimitive(dummy, [Expr, int, float, float, int, int], Expr, name='ts_BBANDS')
pset.addPrimitive(dummy, [Expr, int, float], Expr, name='ts_STDDEV')
pset.addPrimitive(dummy, [Expr, int, float], Expr, name='ts_T3')
pset.addPrimitive(dummy, [Expr, int, float], Expr, name='ts_VAR')
pset.addPrimitive(dummy, [Expr, int, int, int, int, int, int, int], Expr, name='ts_MACDEXT')
pset.addPrimitive(dummy, [Expr, int, int, int, int, int], Expr, name='ts_STOCHRSI')
pset.addPrimitive(dummy, [Expr, int, int, int, int], Expr, name='ts_MACD')
pset.addPrimitive(dummy, [Expr, int, int, int], Expr, name='ts_APO')
pset.addPrimitive(dummy, [Expr, int, int, int], Expr, name='ts_PPO')
pset.addPrimitive(dummy, [Expr, int, int], Expr, name='MINMAX')
pset.addPrimitive(dummy, [Expr, int, int], Expr, name='MINMAXINDEX')
pset.addPrimitive(dummy, [Expr, int, int], Expr, name='ts_MA')
pset.addPrimitive(dummy, [Expr, int, int], Expr, name='ts_MACDFIX')
...
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_DEMA')
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_EMA')
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_HT_PHASOR')
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_HT_SINE')
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_KAMA')
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_LINEARREG')
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_LINEARREG_ANGLE')
pset.addPrimitive(dummy, [Expr, int], Expr, name='ts_LINEARREG_INTERCEPT')
