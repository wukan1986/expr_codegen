...
ADV20, ADV30, ADV40, ADV50, ADV60, ADV180, = symbols('ADV20, ADV30, ADV40, ADV50, ADV60, ADV180,', cls=Symbol)
...
exprs_src = {
    ...
    "alpha_074": (cs_rank(ts_corr(VWAP, VOLUME, 4.24304)) < cs_rank(ts_corr(cs_rank(LOW), cs_rank(ADV50), 12.4413))),
